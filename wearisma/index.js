...
var App = React.createClass({displayName: "App",
  ...
  filterWalkers: function() {
    ...
    /* Check just time */
      ...
      console.log("Checking times only");
    ...
    /* Check just date */
      ...
      console.log("Checking dates only");
      var newWalkers = _.filter(data.walkers, function(obj){
  ...
  render: function() {
    ...
    React.createElement(OutputPanel, {walkers: this.state.walkers, centre: this.state.coords})
    )
  }
});
...
var InputPanel = React.createClass({displayName: "InputPanel",
  render: function() {
    return React.createElement("div", {className: "input-panel"}, 
      React.createElement("h1", {className: "input-header"}, "I'm looking for a dog walker..."), 
      React.createElement(inputs.PostcodeSelector, {updatePostCode: this.props.updatePostCode, postCode: this.props.postCode, parsePostCode: this.props.parsePostCode}), 

      React.createElement(inputs.DatePicker, {date: this.props.date, range: this.props.range, updateDate: this.props.updateDate}), 

      React.createElement(inputs.TimeSelector, {updateTime: this.props.updateTime})
    )
  }
});


var OutputPanel = React.createClass({displayName: "OutputPanel",
  makeMap: function(){
  ...
  renderMarkers: function(walkers) {
    ...
    *  marker and infoWindow for each */
    for (var i in walkers) {
      ...
      /* For debugging which markers are getting
      *  through as props on the render function
      console.log("Creating marker " + i + " with time " + walkers[i].available[0]); */
  ...
  render: function() {
    return React.createElement("div", {id: "map", className: "output-panel"})
  }
});

ReactDOM.render(React.createElement(App, null), document.getElementById('app-wrapper'));

},{"./data.js":160,"./inputs.js":162,"moment":28,"react":159,"react-dom":30}],162:[function(require,module,exports){
var React = require('react'),
    moment = require('moment');

var inputs = new Object();

inputs.PostcodeSelector = React.createClass({displayName: "PostcodeSelector",
  render: function() {
    return (
      React.createElement("form", {onSubmit: this.props.parsePostCode, onChange: this.props.updatePostCode, name: "postcode", className: "postcode-selector"}, 
        React.createElement("input", {type: "text", placeholder: "Postcode...", value: this.props.postCode})
      )
    );
  }
});

inputs.DatePicker= React.createClass({displayName: "DatePicker",
  render: function() {
    ...
    for (i in this.props.range){
      ...
      var option = React.createElement("option", {key: i, value: this.props.range[i]}, 
        formattedDate
      )
    ...
    return (
      React.createElement("div", {className: "date-picker"}, 
        React.createElement("select", {name: "date", onChange: this.props.updateDate}, 
          React.createElement("option", {value: "none"}, "Select a date"), 
          dateOptions
        )
      )
    );
...
inputs.TimeSelector = React.createClass({displayName: "TimeSelector",
  render: function() {
    return (
      React.createElement("div", {className: "time-selector"}, 
        React.createElement("select", {onChange: this.props.updateTime, name: "time"}, 
          React.createElement("option", {value: "none"}, "Select a time"), 
          React.createElement("option", {value: "05:00"}, "5:00"), 
          React.createElement("option", {value: "06:00"}, "6:00"), 
          React.createElement("option", {value: "07:00"}, "7:00"), 
          React.createElement("option", {value: "08:00"}, "8:00"), 
          React.createElement("option", {value: "09:00"}, "9:00"), 

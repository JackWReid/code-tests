...
var DonateButton = function (_React$Component) {
  ...
  function DonateButton() {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(DonateButton).apply(this, arguments));
  }
  ...
  _createClass(DonateButton, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'button',
        { className: 'donate-button', onClick: this.props.donate },
        'Donate'
      );
    }
  }]);
...
var ProgressBar = function (_React$Component2) {
  ...
  function ProgressBar(props) {
    ...
    var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(ProgressBar).call(this, props));
  ...
  _createClass(ProgressBar, [{
    key: 'raiseBar',
    value: function raiseBar() {
      var changeState = this.state.innerBStyle;

      if (changeState.width === '0%') {
        changeState.width = (0, _utility.formatPercent)(this.props.data.goal, this.props.data.current);
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement('div', { style: this.state.innerBStyle, 'class': 'progress-bar__inner' })
      );
    }
  }]);
...
var DonateBar = function (_React$Component3) {
  _inherits(DonateBar, _React$Component3);

  function DonateBar() {
    _classCallCheck(this, DonateBar);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(DonateBar).apply(this, arguments));
  }

  _createClass(DonateBar, [{
    key: 'donate',
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(DonateButton, { donate: this.donate }),
        _react2.default.createElement(
          'div',
          { className: 'donate-bar__info' },
          _react2.default.createElement(
            'h1',
            { className: 'donate-bar__info__total' },
            _react2.default.createElement(
              'span',
              { className: 'donate-bar__info__total__figure' },
              (0, _utility.formatCurrency)(this.props.data.stats.current, this.props.data.meta.currency)
            ),
            ' raised'
          ),
          _react2.default.createElement(ProgressBar, { data: this.props.data.stats }),
          _react2.default.createElement(
            'h2',
            { className: 'donate-bar__info__goal' },
            'of ',
            _react2.default.createElement(
              'span',
              { className: 'donate-bar__info__goal__figure' },
              (0, _utility.formatCurrency)(this.props.data.stats.goal, this.props.data.meta.currency)
            ),
            ' goal'
          ),
          _react2.default.createElement(
            'div',
            { className: 'donate-bar__info__percentage' },
            (0, _utility.formatPercent)(this.props.data.stats.goal, this.props.data.stats.current)
          )
        )
      );
    }
...
var BenefactorList = function (_React$Component4) {
  _inherits(BenefactorList, _React$Component4);

  function BenefactorList() {
    _classCallCheck(this, BenefactorList);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(BenefactorList).apply(this, arguments));
  }

  _createClass(BenefactorList, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'ul',
        { className: 'benefactor-list' },
        this.props.data.donations.map(function (donation) {

          return _react2.default.createElement(
            'li',
            { key: donation.donation.id, className: 'donation-item' },
            _react2.default.createElement('img', { className: 'donation-item__image', src: donation.user.image, alt: donation.user.username }),
            _react2.default.createElement(
              'div',
              { className: 'donation-item__info' },
              _react2.default.createElement(
                'span',
                { className: 'donation-item__info__name' },
                donation.user.name
              ),
              ' donated ',
              (0, _utility.formatQuantity)(donation.donation.quantity),
              ' ',
              (0, _utility.formatAgo)(donation.donation.time)
            )
          );
        })
      );
...
var DonationWidget = function (_React$Component5) {
  _inherits(DonationWidget, _React$Component5);

  function DonationWidget() {
    _classCallCheck(this, DonationWidget);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(DonationWidget).apply(this, arguments));
  }

  _createClass(DonationWidget, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'donation-widget' },
        _react2.default.createElement(DonateBar, { data: this.props.data }),
        _react2.default.createElement(BenefactorList, { data: this.props.data })
      );
    }
  }]);
...
_reactDom2.default.render(_react2.default.createElement(DonationWidget, { data: _data.campaignData }), document.getElementById('donationWidget'));

},{"./data.js":169,"./utility.js":170,"react":167,"react-dom":29}],169:[function(require,module,exports){
'use strict';
...
function formatCurrency(num) {
  var currency = arguments.length <= 1 || arguments[1] === undefined ? 'gbp' : arguments[1];
...
function formatQuantity(quantity, currency) {
  if (quantity === null) {
    return '';
  } else {
...
function formatPercent(den, num) {
  var value = num / den;
